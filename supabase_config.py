...
try:
    ...
    def insert_sensor_data(temperature1, humidity1, temperature2, humidity2, soil_moisture1, soil_moisture2, uv_index, timestamp):
        ...
        try:
            ...
            # Supabase insert error - check logs
            import sys
            sys.stderr.write(f"Supabase insert error: {str(e)}\n")
            return False
    ...
    def get_latest_sensor_data():
        ...
        try:
            ...
            # Supabase get_latest error
            import sys
            sys.stderr.write(f"Supabase get_latest error: {str(e)}\n")
            return None
